...
public class GRPCClient {
    ...
    private static final String SERVER = System.getenv("TARGET_SERVER");

    private static final Integer INTERVAL = Integer.parseInt(System.getProperty("INTERVAL","100"));
    ...
    public static void main(String[] args) throws Exception {
        String user = "world";
        // 访问本机在50051端口上运行的服务
        String target = Optional.ofNullable(SERVER).orElse("localhost:50051");
        ...
        try {
            ...
            while (true) {
                ...
                client.greet(user);
                TimeUnit.MICROSECONDS.sleep(Optional.ofNullable(INTERVAL).orElse(100));
            }
        } finally {
